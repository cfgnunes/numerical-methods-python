...
def example_solution_bisection():
    ...
    # Algoritmos Numericos (Campos, 2nd), Chap. 6.2, Example 6.20, p. 290.
...
def example_solution_secant():
    ...
    # Algoritmos Numericos (Campos, 2nd), Chap. 6.3.1, Example 6.22, p. 293.
...
def example_solution_regula_falsi():
    ...
    # Algoritmos Numericos (Campos, 2nd), Chap. 6.3.2, Example 6.23, p. 295.
...
def example_solution_pegasus():
    ...
    # Algoritmos Numericos (Campos, 2nd), Chap. 6.3.3, Example 6.24, p. 298.
...
def example_solution_muller():
    ...
    # Algoritmos Numericos (Campos, 2nd), Chap. 6.4.1, Example 6.26, p. 303.
...
def example_interpolation_lagrange():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 3.1, Example 2, p. 110.
    x = np.array([2, 11 / 4, 4])
...
def example_interpolation_newton():
    ...
    # Algoritmos Numericos (Campos, 2nd), Chap. 3.3, Example 3.11, p. 137.
...
def example_interpolation_gregory_newton():
    ...
    # Algoritmos Numericos (Campos, 2nd), Chap. 3.4, Example 3.17, p. 143.
...
def example_interpolation_neville():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 3.2, Example 2, p. 120.
...
def example_polynomial_root_limits():
    ...
    # Algoritmos Numericos (Campos, 2nd), Chap. 6.1, Example 6.13, p. 280.
...
def example_polynomial_briot_ruffini():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 2.6, Example 2, p. 93.
...
def example_polynomial_newton_divided_difference():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 3.3, Example 1, p. 127.
    x = np.array([1.0, 1.3, 1.6, 1.9, 2.2])
    y = np.array([0.7651977, 0.6200860, 0.4554022, 0.2818186, 0.1103623])
...
def example_differentiation_backward_difference():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 4.1, Exercise 1(b), p. 182.
...
def example_differentiation_three_point():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 4.1, Exercise 5(a), p. 182.
...
def example_differentiation_five_point():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 4.1, Exercise 9(a), p. 183.
...
def example_trapezoidal_array():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 4.4, Exercise 22, p. 211.
...
def example_trapezoidal():
    """Run an example 'Integration: Trapezoidal Rule'."""
    # Numerical Analysis (Burden, 9th), Chap. 4.4, Exercise 7(a), p. 210.
    def f(x):
...
def example_simpson():
    """Run an example 'Integration: Composite 1/3 Simpson's Rule'."""
    # Numerical Analysis (Burden, 9th), Chap. 4.4, Exercise 7(b), p. 210.
    def f(x):
        return x ** 2 * math.log(x ** 2 + 1)
...
def example_romberg():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 4.4, Exercise 7, p. 210.
    def f(x):
        return x ** 2 * math.log(x ** 2 + 1)
...
def example_ode_euler():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 5.2, Example 1, p. 268.
    def f(x, y):
        return y - x ** 2 + 1
...
def example_ode_taylor2():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 5.3, Example 1(a), p. 278.
    def f(x, y):
        return y - x ** 2 + 1
...
def example_ode_taylor4():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 5.3, Example 1(b), p. 278.
    def f(x, y):
        return y - x ** 2 + 1
...
def example_ode_rk4():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 5.4, Example 3, p. 289.
    def f(x, y):
        return y - x ** 2 + 1
...
def example_ode_rk4_system():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 5.9, Illustration, p. 331.
    f = []
...
def example_gauss_elimination_pp():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 6.1, Example 2, p. 363.
...
def example_jacobi():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 7.3, Example 1, p. 451.
...
def example_gauss_seidel():
    ...
    # Numerical Analysis (Burden, 9th), Chap. 7.3, Example 2, p. 453.
    a = np.array([[10, -1, 2, 0], [-1, 11, -1, 3],
                  [2, -1, 10, -1], [0, 3, -1, 8]])
    b = np.array([6, 25, -11, 15])
    x0 = np.array([0, 0, 0, 0])
